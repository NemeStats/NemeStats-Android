...
public class NemeStatsAuthenticationInterceptor implements Interceptor {
    ...
    @Inject
    public NemeStatsAuthenticationInterceptor(AccountLocalRepo accountLocalRepo) {
    ...
    public Response intercept(Interceptor.Chain chain) throws IOException {
        ...
        signedRequest.addHeader(KEY_AUTHORIZATION, mAccountLocalRepo.getAuthenticationToken());
