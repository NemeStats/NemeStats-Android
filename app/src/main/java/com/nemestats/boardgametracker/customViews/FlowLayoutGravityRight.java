...
public class FlowLayoutGravityRight extends ViewGroup {
    private int mHorizontalSpacing;
    private int mVerticalSpacing;
    private OnSizeChangedListener mOnSizeChangedListener;

    public FlowLayoutGravityRight(Context context, AttributeSet attrs) {
        super(context, attrs);
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        int currentWidth = widthSize - getPaddingLeft();
        int currentHeight = 0;
        ...
        for (int i = 0; i < count; i++) {
            ...
            FlowLayoutGravityRight.LayoutParams layoutParams = (FlowLayoutGravityRight.LayoutParams) child.getLayoutParams();
            spacing = mHorizontalSpacing;

            if (growHeight && (currentWidth - child.getMeasuredWidth() < 0)) {
            ...
            layoutParams.x = currentWidth - child.getMeasuredWidth() ;
